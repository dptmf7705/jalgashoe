...
import com.dankook.jalgashoe.profile.setting.SettingActivity;
...
public class BluetoothChatService {
    ...
    private synchronized void setState(int state) {
        ...
        // 상태를 액티비티에도 전달한다.
        mHandler.obtainMessage(SettingActivity.MESSAGE_STATE_CHANGE,
    ...
    public synchronized void connected(BluetoothSocket socket,
        ...
        Message msg = mHandler.obtainMessage(
                SettingActivity.MESSAGE_DEVICE_NAME);

        Bundle bundle = new Bundle();
        bundle.putString(SettingActivity.DEVICE_NAME,
                device.getName());
    ...
    private void connectionFailed() {
        Message msg =
                mHandler.obtainMessage(SettingActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(SettingActivity.TOAST,
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SettingActivity.MESSAGE_READ,
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(SettingActivity.MESSAGE_WRITE,
